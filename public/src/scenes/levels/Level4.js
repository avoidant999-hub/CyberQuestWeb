...
export class Level4 extends Phaser.Scene {
  ...
  createHeader(width, height) {
    ...
    const btnBg = this.add.graphics().fillStyle(THEME.colors.danger, 1).fillRoundedRect(-50, -20, 100, 40, 10);
    const btnTxt = this.add.text(0, 0, "KELUAR", { fontFamily: THEME.fonts.header, fontSize: "12px", fontStyle:"bold", color:"#fff" }).setOrigin(0.5);
    
    btnExit.add([btnBg, btnTxt])
